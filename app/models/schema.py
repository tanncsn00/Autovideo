...
class VideoParams(BaseModel):
    ...
    color_preset: str = "none"  # none, cinematic, warm, cool, vintage, noir, vibrant, muted, high_contrast
    caption_style: str = "default"  # default, hormozi, documentary, tiktok-viral, corporate
    prompt_template: str = ""  # ID of prompt template to use for script generation
